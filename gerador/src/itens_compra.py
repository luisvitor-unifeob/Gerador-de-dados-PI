...
def calcular_quantidade_unidades(categoria):
    """
    Define quantas unidades daquele
...
def calcular_desconto(subtotal):
    ...
    O campo desconto armazena o valor
    monetário descontado.
    """
