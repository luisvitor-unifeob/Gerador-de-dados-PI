...
CATEGORIAS = {
    ...
    "Moeda virtual": ["100 Moedas", "500 Moedas", "1000 Moedas", "2500 Moedas"],
    "Personagem": [
    ...
    "DLC": ["Expansão Norte", "Expansão Sombria", "Expansão Final"],
    "Boost": ["Boost de XP", "Boost de Moedas", "Boost de Progressão"],
    "Pacote": ["Pacote Inicial", "Pacote Premium", "Pacote Lendário"],
    "Emote": ["Emote Dança", "Emote Vitória", "Emote Provocação"],
    "Acessório": ["Mochila Especial", "Pingente", "Bandeira", "Insígnia"]
}

#Raridades disponíveis
RARIDADES = ["Comum", "Incomum", "Rara", "Épica", "Lendária"]

#Preços possíveis de acordo com a raridade
PRECOS_POR_RARIDADE = {
    "Comum": [4.90, 9.90],
...
def escolher_raridade():
    #Raridades comuns aparecem com mais frequência que raridades altas
